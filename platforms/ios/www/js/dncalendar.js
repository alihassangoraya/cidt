        ...
        var draw = function () {
            ...
            for (var i = 0; i < nDates; i++) {
                ...
                for (var j = 0; j < nDate; j++) {
                    ...
                    var newMonth = month, newDate = date;
                    if(month < 10)
                    {
                        newMonth = "0"+month;
                    }
                    ...
                    var dateToDisplay = year+"-"+newMonth+"-"+newDate;

                    if (datesArray.indexOf(dateToDisplay) > -1) {
                        var color = colorsArray[datesArray.indexOf(dateToDisplay)];

                        if(color == "red") {
                            colDateClass += " overDrunk ";
                        }
                        else{
                            colDateClass += " normalDrunk ";
                        }
                    }
